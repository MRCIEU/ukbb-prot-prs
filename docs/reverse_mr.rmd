...
sum(res_out_sum$fdr_orig & res_out_sum$fdr_out)
```
...
tribble(
    ...
    "Reverse MR FDR < 0.05 after outlier removal", sum(res_out_sum$fdr_orig & res_out_sum$fdr_out),
    "Mean number of instruments", mean(res_out_sum$nsnp_orig),
    "Mean number of outliers", mean(res_out_sum$noutliers)
)
