...
```{r}
setwd("~/sandpit/ukbb_prot_prs/")
download.file("https://www.biorxiv.org/content/biorxiv/early/2022/06/18/2022.06.17.496443/DC2/embed/media-2.xlsx?download=true", "media-2.xlsx")
a <- read_xlsx("media-2.xlsx", sheet="ST6", skip=2)
a
```

```{r}
b <- read_xlsx("~/Downloads/supplementary_tables.xlsx", sheet=1, skip=1)
b
```
